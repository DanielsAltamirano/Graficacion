...
mascara = cv2.imread(r'C:\Users\Daniels\Desktop\graficacion\Recursos\tobimascara.png', cv2.IMREAD_UNCHANGED)  # Cargar PNG con transparencia
...
while True:
    ...
    for (x, y, w, h) in rostros:
        # Especificar un tamaño manualmente
        nuevo_ancho = 200  # Cambia este valor según sea necesario
        nuevo_alto = 150   # Cambia este valor según sea necesario
